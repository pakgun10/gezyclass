...
<div class="note">
💡 <strong>Tips:</strong> Operasi bentuk akar mirip dengan operasi aljabar biasa. Anggap $\sqrt{a}$ seperti variabel $x$. Maka $3\sqrt{2} + 5\sqrt{2}$ sama seperti $3x + 5x = 8x$.
</div>
