...
1. **Mengintegrasikan** semua konsep Pythagoras dalam pemecahan masalah
2. **Menyelesaikan** soal kompleks yang melibatkan gabungan konsep
3. **Menganalisis** dan memilih strategi penyelesaian yang tepat
...
$AE^2 = (AB)^2 + (BC + DE)^2 = 10^2 + 10^2 = 200$
$AE = \sqrt{200} = 10\sqrt{2}$ cm
...
<div class="note">
🎉 <strong>Selamat!</strong> Kamu telah menyelesaikan seluruh materi Teorema Pythagoras. Terus latihan soal-soal campuran untuk menguasai konsepnya!
</div>
