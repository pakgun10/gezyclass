...
> 💡 **Tips:** Positif × Positif = Positif. Negatif × Negatif = Positif. Beda tanda = Negatif.

### Contoh 1: Perkalian

| Soal | Penyelesaian | Hasil |
|:---:|:------------:|:-----:|
| $3 \times 5$ | Positif × Positif | $15$ |
| $4 \times (-7)$ | Positif × Negatif | $-28$ |
| $(-6) \times 8$ | Negatif × Positif | $-48$ |
| $(-5) \times (-9)$ | Negatif × Negatif | $45$ |
...
| Soal | Penyelesaian | Hasil |
|:---:|:------------:|:-----:|
| $20 \div 4$ | Positif ÷ Positif | $5$ |
| $15 \div (-3)$ | Positif ÷ Negatif | $-5$ |
| $(-24) \div 6$ | Negatif ÷ Positif | $-4$ |
| $(-36) \div (-9)$ | Negatif ÷ Negatif | $4$ |
| $0 \div (-8)$ | Nol ÷ berapa pun | $0$ |
| $(-7) \div 0$ | **Tidak terdefinisi** | — |
...
| Prioritas | Operasi |
|:---------:|:-------:|
| **1. K** | **Kurung** — selesaikan dulu yang di dalam $(\dots)$ |
| **2. A** | **Akar** — selesaikan bentuk akar |
| **3. B** | **Bagi** — bagi dari kiri ke kanan |
| **4. T** | **Kali** — kali dari kiri ke kanan |
| **5. A** | **Tambah** — jumlah dari kiri ke kanan |
| **6. KU** | **Kurang** — kurangi dari kiri ke kanan |

> Untuk tingkat SMP, cukup ingat: **Kurung → Kali/Bagi → Tambah/Kurang**
...
| No | Konsep | Aturan |
|:--:|:------:|:-------|
| 1 | **Perkalian** | Sama tanda → positif. Beda tanda → negatif. |
| 2 | **Pembagian** | Aturan tanda sama dengan perkalian. |
| 3 | **Sifat** | Komutatif, asosiatif, distributif. |
| 4 | **Prioritas** | Kurung → Kali/Bagi → Tambah/Kurang |
| 5 | **Nol** | $a \times 0 = 0$. $0 \div a = 0$. $a \div 0$ tak terdefinisi. |

<div class="note">
💡 <strong>Tips Akhir:</strong> Seluruh operasi bilangan bulat hanya punya satu aturan kunci: <strong>sama tanda hasil positif, beda tanda hasil negatif</strong>. Hafalkan ini, maka perkalian dan pembagian akan mudah!
</div>
...
<div class="note">
🎉 <strong>Selamat!</strong> Kamu telah menyelesaikan seluruh materi Bilangan Bulat untuk kelas 7. Empat sub-materi telah dipelajari:
<ol>
<li>Konsep dan Garis Bilangan Bulat</li>
<li>Membandingkan dan Mengurutkan Bilangan Bulat</li>
<li>Penjumlahan dan Pengurangan</li>
<li>Perkalian, Pembagian, dan Operasi Campuran</li>
</ol>
