...
$L_{\text{juring}} = 154$
$L_{\text{segitiga}} = \frac12 \times 14 \times 14 = 98$
$L_{\text{tembereng}} = 154 - 98 = 56 \text{ cm}^2$
...
$L_{\text{taman}} = \frac{22}{7} \times (10,5)^2 = \frac{22}{7} \times 110,25 = 346,5 \text{ m}^2$
$L_{\text{kolam}} = \frac{22}{7} \times 3,5^2 = 38,5 \text{ m}^2$
$L_{\text{sisanya}} = 346,5 - 38,5 = 308 \text{ m}^2$
...
<div class="note">
💡 <strong>Tips:</strong> Juring = potongan pizza. Tembereng = juring dikurangi segitiga. Busur + juring selalu berpasangan dengan sudut pusat yang sama.
</div>
